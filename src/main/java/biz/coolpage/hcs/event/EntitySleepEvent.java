...
public class EntitySleepEvent {
    ...
    public static void onSleepFinished(SleepFinishedTimeEvent event) {
        // todo Forge does not have a direct 1:1 for Fabric's ALLOW_RESETTING_TIME that fires per-player easily,
        // but SleepFinishedTimeEvent handles the morning transition.
