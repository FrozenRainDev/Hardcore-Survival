...
public class Reg implements ModInitializer {
    ...
    public static final Item WORM = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(2).saturationModifier(1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 200), 1).build()), 0.0F, -0.08F);
    ...
    public static final Item ROASTED_WORM = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(3).saturationModifier(1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 60), 1).build()), 0.0F, -0.01F);
    ...
    public static final Item JERKY = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(8).saturationModifier(8.0F).meat().build()), 3.0F, 0.15F);
    public static final Item SMALL_JERKY = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(5).saturationModifier(5.0F).meat().build()), 1.5F, 0.08F);
    public static final Item RAW_JERKY = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(4).saturationModifier(4.0F).meat().build()), 1.5F, 0.0F);
    public static final Item RAW_SMALL_JERKY = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(3).saturationModifier(3.0F).meat().build()), 1.0F, 0.0F);
    ...
    public static final Item COLD_WATER_BOTTLE = new BottleItem(new Item.Settings().maxCount(16)) {
        ...
        public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
            if (user instanceof ServerPlayerEntity player) {
                ...
                if (temperatureManager.get() > 0.4F) temperatureManager.add(-0.3F);
