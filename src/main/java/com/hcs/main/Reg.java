...
public class Reg implements ModInitializer {
    ...
    public static final Item WORM = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(2).saturationModifier(1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 200), 1).build()));
    ...
    public static final Item ROASTED_WORM = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(3).saturationModifier(1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 60), 1).build()));
    ...
    public static final Item JERKY = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(8).saturationModifier(8.0F).meat().build()), 3.0F, 0.1F);
    public static final Item SMALL_JERKY = new EffectiveFoodItem(new Item.Settings().food(new FoodComponent.Builder().hunger(5).saturationModifier(5.0F).meat().build()), 1.5F, 0.05F);
